...
const MedAlternativasB$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
  ...
  static get style() { return medAlternativasBCss; }
};

const MedAlternativasB = /*@__PURE__*/proxyCustomElement(MedAlternativasB$1, [1,"med-alternativas-b",{"dsColor":[1,"ds-color"],"dsSkin":[8,"ds-skin"],"dsSkinConfig":[8,"ds-skin-config"],"alternativas":[1032],"keyAlternativa":[1,"key-alternativa"],"keyEnunciado":[1,"key-enunciado"],"keyImagem":[1,"key-imagem"],"keyPorcentagem":[1,"key-porcentagem"],"keyRiscada":[1,"key-riscada"],"respostaCorreta":[1537,"resposta-correta"],"mostraResposta":[1540,"mostra-resposta"],"alternativaSelecionada":[1537,"alternativa-selecionada"],"permiteRiscar":[1028,"permite-riscar"],"permiteAlterar":[32],"riscarAtivoIndice":[32]},[[8,"click","handleClick"]]]);

export { MedAlternativasB };
