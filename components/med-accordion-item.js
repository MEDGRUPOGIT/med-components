...
const MedAccordionItem$1 = class extends HTMLElement {
  ...
  render() {
    ...
    return (h(Host, { "from-stencil": true, class: generateMedColor(dsColor, {
      ...
      }) }, h("div", { class: "med-accordion-item__header", ref: (el) => this.header = el }, h("div", { class: "med-accordion-item__header-container" }, icon === 'left' && h("div", { class: "med-accordion-item__icon-container med-accordion-item__icon-container--left", onClick: () => this.onClick() }, h("ion-icon", { class: "med-icon med-accordion-item__icon", name: "med-baixo" })), h("div", { class: "med-accordion-item__heading", onClick: () => this.onClick() }, h("slot", { name: "header" }), h("slot", { name: "auxiliar" })), h("slot", { name: "button" }), (!icon || icon === 'right') && h("div", { class: "med-accordion-item__icon-container med-accordion-item__icon-container--right", onClick: () => this.onClick() }, h("ion-icon", { class: "med-icon med-accordion-item__icon", name: "med-baixo" }))), h("div", { class: "med-accordion-item__bar" }, h("slot", { name: "progress" }))), h("div", { class: "med-accordion-item__content", ref: (el) => this.content = el }, h("slot", { name: "content" }))));
  }
  get hostElement() { return this; }
  static get style() { return medAccordionItemCss; }
};

const MedAccordionItem = /*@__PURE__*/proxyCustomElement(MedAccordionItem$1, [1,"med-accordion-item",{"dsColor":[513,"ds-color"],"icon":[513],"noBorder":[516,"no-border"],"background":[516],"isOpen":[32]}]);

export { MedAccordionItem };
