...
const MedAlternativas$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
...
const MedAlternativas = /*@__PURE__*/proxyCustomElement(MedAlternativas$1, [1,"med-alternativas",{"podeRiscar":[4,"pode-riscar"],"isDesktop":[4,"is-desktop"],"alternativas":[8],"keyAlternativa":[1,"key-alternativa"],"keyEnunciado":[1,"key-enunciado"],"keyImagem":[1,"key-imagem"],"keyPorcentagem":[1,"key-porcentagem"],"respostaCorreta":[1537,"resposta-correta"],"mostraResposta":[1540,"mostra-resposta"],"alternativaSelecionada":[1537,"alternativa-selecionada"],"color":[1],"alternativaRiscada":[32],"alternativaPressionada":[32]}]);

export { MedAlternativas };
