...
import { M as MedSkin } from './skin.enum.js';
...
const MedAlternativas = /*@__PURE__*/proxyCustomElement(MedAlternativas$1, [1,"med-alternativas",{"dsColor":[1,"ds-color"],"alternativas":[1032],"dsSkinConfig":[8,"ds-skin-config"],"keyAlternativa":[1,"key-alternativa"],"keyEnunciado":[1,"key-enunciado"],"keyImagem":[1,"key-imagem"],"keyPorcentagem":[1,"key-porcentagem"],"keyRiscada":[1,"key-riscada"],"respostaCorreta":[1537,"resposta-correta"],"mostraResposta":[1540,"mostra-resposta"],"alternativaSelecionada":[1537,"alternativa-selecionada"],"permiteRiscar":[1028,"permite-riscar"]}]);
