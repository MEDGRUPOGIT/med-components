...
import { M as MedFontSize } from './font-size.enum.js';
...
const MedFontZoom$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
...
const MedFontZoom = /*@__PURE__*/proxyCustomElement(MedFontZoom$1, [1,"med-font-zoom",{"emitter":[16],"value":[1]}]);
