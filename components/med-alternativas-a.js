...
import { M as MedAlternativasBase } from './med-alternativas-base.js';
...
const MedAlternativasA$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
  ...
  render() {
    ...
    return (h(Host, { "from-stencil": true, class: generateMedColor(dsColor, {
      ...
      h("div", { class: `image-container ${alternativa[this.keyEnunciado] ? 'image-container--margin' : ''}`, onClick: (event) => this.baseClass.imageRequest(event, alternativa) }, h("div", { class: 'image-container__wrapper' }, h("img", { class: 'image-container__image', src: alternativa[this.keyImagem] }), h("div", { class: 'image-container__button' }, h("ion-icon", { name: "med-expand image-container__icon" }))))), h("div", { class: `med-alternativas__riscar ${indice === this.riscarAtivoIndice && permiteRiscar ? 'med-alternativas__riscar--show' : ''}`, onClick: (event) => { this.baseClass.riscar(event, alternativa); } }, h("ion-icon", { class: "med-alternativas__riscar-icon med-icon", name: "med-riscar" }), h("div", { class: "med-alternativas__riscar-span" }, (alternativa[this.keyRiscada] ? 'Restaurar ' : 'Riscar '), h("span", { class: "med-alternativas__riscar-desktop" }, " alternativa"))))), h("ion-progress-bar", { percentage: true, class: `
  ...
  static get style() { return medAlternativasACss; }
};

const MedAlternativasA = /*@__PURE__*/proxyCustomElement(MedAlternativasA$1, [1,"med-alternativas-a",{"dsSkin":[8,"ds-skin"],"dsSkinConfig":[8,"ds-skin-config"],"dsColor":[1,"ds-color"],"alternativas":[1032],"keyAlternativa":[1,"key-alternativa"],"keyEnunciado":[1,"key-enunciado"],"keyImagem":[1,"key-imagem"],"keyPorcentagem":[1,"key-porcentagem"],"keyRiscada":[1,"key-riscada"],"respostaCorreta":[1537,"resposta-correta"],"mostraResposta":[1540,"mostra-resposta"],"alternativaSelecionada":[1537,"alternativa-selecionada"],"permiteRiscar":[1028,"permite-riscar"],"permiteAlterar":[32],"riscarAtivoIndice":[32]},[[8,"click","handleClick"]]]);

export { MedAlternativasA };
