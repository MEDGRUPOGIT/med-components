...
const MedAccordion$1 = class extends HTMLElement {
  ...
  render() {
    ...
    return (h(Host, { "from-stencil": true, class: createColorClasses(color, {
      ...
      }) }, h("div", { class: "med-accordion__header", onClick: (event) => this.onClick(event) }, icon === 'left' && h("div", { class: "med-accordion__icon-container med-accordion__icon-container--left" }, h("ion-icon", { class: "med-icon med-accordion__icon", name: "med-baixo" })), h("slot", { name: "header" }), (!icon || icon === 'right') && h("div", { class: "med-accordion__icon-container med-accordion__icon-container--right" }, h("ion-icon", { class: "med-icon med-accordion__icon", name: "med-baixo" }))), h("div", { class: "med-accordion__content--fake", ref: (el) => this.contentFakeEl = el }, h("slot", { name: "content-fake" })), h("div", { class: "med-accordion__content", ref: (el) => this.contentEl = el }, h("slot", { name: "content" }))));
  }
  get el() { return this; }
