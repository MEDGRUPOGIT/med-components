...
const Accordion = class extends HTMLElement {
  ...
  render() {
    ...
    return (h(Host, { "from-stencil": true, class: createColorClasses(null, {
      ...
      }, null) }, h("slot", null), h("div", { class: "med-accordion-list__blocker", ref: (el) => this.blocker = el })));
  }
  get hostElement() { return this; }
  static get style() { return medAccordionListCss; }
};

const MedAccordionList = /*@__PURE__*/proxyCustomElement(Accordion, [1,"med-accordion-list",{"noBorder":[516,"no-border"],"singleOpen":[516,"single-open"],"margin":[1]},[[0,"toggle","handleToggle"]]]);

export { MedAccordionList };
