...
const MedNavbar$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
  ...
  get el() { return this; }
  static get style() { return medNavbarCss; }
};

const MedNavbar = /*@__PURE__*/proxyCustomElement(MedNavbar$1, [1,"med-navbar",{"dsColor":[513,"ds-color"],"dsName":[1,"ds-name"]}]);
