...
const Range = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onFocusin: this.onFocus, onFocusout: this.onBlur, class: medTheme.generateMedColor(dsColor, {
        [mode]: true,
