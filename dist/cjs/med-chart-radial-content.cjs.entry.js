...
const MedChartRadialContent = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "from-stencil": true, class: theme.createColorClasses(null, {
      ...
      }, null) }, index.h("span", { class: "med-chart-radial-content__label" }, "Total de"), index.h("span", { class: `med-chart-radial-content__number ${this.fontResize()}` }, total), index.h("span", { class: "med-chart-radial-content__label" }, "Quest\u00F5es")));
  }
