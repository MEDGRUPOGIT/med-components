...
const Select = class {
  ...
  render() {
    ...
    const displayLabel = labelText !== undefined
      ...
      : selectText;
    return (index.h(index.Host, { onClick: this.onClick, role: "button", "aria-haspopup": "listbox", "aria-disabled": disabled ? 'true' : null, "aria-label": displayLabel, class: medTheme.generateMedColor(dsColor, {
        [mode]: true,
        'in-item': theme.hostContext('ion-item', el),
        'select-disabled': disabled,
        'select-expanded': isExpanded,
        'med-select': true
      }) }, index.h("div", { "aria-hidden": "true", class: selectTextClasses, part: textPart }, selectText), index.h("ion-icon", { class: "med-icon med-select-icon", name: "med-baixo" }), index.h("label", { id: labelId }, displayLabel), index.h("button", { type: "button", disabled: disabled, id: inputId, "aria-labelledby": labelId, "aria-haspopup": "listbox", "aria-expanded": `${isExpanded}`, onFocus: this.onFocus, onBlur: this.onBlur, ref: (focusEl => this.focusEl = focusEl) })));
  }
