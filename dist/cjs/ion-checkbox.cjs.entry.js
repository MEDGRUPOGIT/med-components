...
const Checkbox = class {
  ...
  render() {
    ...
    let path = indeterminate
      ...
      ? index.h("div", { class: "indeterminate" })
    ...
    return (index.h(index.Host, { onClick: this.onClick, "aria-labelledby": label ? labelId : null, "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "checkbox", class: medTheme.generateMedColor(dsColor, {
        [mode]: true,
        ...
        'interactive': true
      }) }, index.h("div", { part: "container", class: "checkbox-icon" }, path), index.h("label", { htmlFor: inputId }, labelText), index.h("input", { type: "checkbox", "aria-checked": `${checked}`, disabled: disabled, id: inputId, onFocus: () => this.onFocus(), onBlur: () => this.onBlur(), ref: focusEl => this.focusEl = focusEl })));
  }
