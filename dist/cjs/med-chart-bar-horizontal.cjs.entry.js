...
const MedChartBarHorizontal = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: medTheme.generateMedColor(dsColor, { [`med-chart-bar-horizontal ${progressClass}`]: true, }), "aria-valuenow": value, "aria-valuemin": "0", "aria-valuemax": "1", role: "progressbar" }, index.h("div", { class: "med-chart-bar-horizontal__container" }, index.h("div", { class: "med-chart-bar-horizontal__progress", part: "progress", style: { '--progress': `${progressWidth === 0 ? -100 : progressWidth - 100}` } }), index.h("div", { class: "med-chart-bar-horizontal__track", part: "track" })), index.h("med-type", { class: "med-chart-bar-horizontal__label", token: "p10b" }, value, "%")));
  }
};
