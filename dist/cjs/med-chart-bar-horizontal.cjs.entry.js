...
const MedChartBarHorizontal = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: color.generateMedColor(dsColor, {
      ...
      }), "aria-valuenow": value, "aria-valuemin": "0", "aria-valuemax": "1", role: "progressbar" }, index.h("div", { class: "med-chart-bar-horizontal__container" }, index.h("div", { class: "med-chart-bar-horizontal__progress", style: { '--progress': `${progressWidth === 0 ? -99 : progressWidth - 100}` } }), index.h("div", { class: "med-chart-bar-horizontal__track" })), label && index.h("med-type", { class: "med-chart-bar-horizontal__label" }, !hideValue ? `${value}%` : '', labelContent)));
  }
};
MedChartBarHorizontal.style = medChartBarHorizontalCss;

exports.med_chart_bar_horizontal = MedChartBarHorizontal;
