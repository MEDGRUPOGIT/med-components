...
const MedNavbar = class {
  ...
  setSize() {
    ...
    this.hostResizeObserver = new index(() => {
  ...
  render() {
    return (index$1.h(index$1.Host, { "from-stencil": true }, index$1.h("header", { class: "header" }, index$1.h("slot", { name: "top" }), index$1.h("div", { class: "header__container" }, index$1.h("div", { id: "left", class: "left", ref: (el) => this.leftEl = el }, index$1.h("slot", { name: "left" })), index$1.h("div", { class: "center", ref: (el) => this.centerEl = el }, index$1.h("slot", { name: "center" }), index$1.h("slot", { name: "title" }), index$1.h("slot", { name: "subtitle" })), index$1.h("div", { id: "right", class: "right", ref: (el) => this.rightEl = el }, index$1.h("slot", { name: "right" }))))));
  }
