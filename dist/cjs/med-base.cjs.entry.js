...
const MedBase = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: medTheme.generateMedColor(dsColor, {
      ...
      }) }, index.h("slot", { name: "start" }), index.h("slot", { name: "middle" }), index.h("slot", { name: "end" }), index.h("slot", null)));
  }
};
MedBase.style = medBaseCss;

exports.med_base = MedBase;
