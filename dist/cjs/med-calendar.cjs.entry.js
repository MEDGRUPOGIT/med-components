...
const MedCalendar = class {
  ...
  render() {
    const { dsColor } = this;
    return (index.h(index.Host, { class: medTheme.generateMedColor(dsColor, { 'med-badge': true }) }, index.h("div", { class: "header" }, index.h("div", { class: "header__left" }, index.h("ion-button", { "ds-name": "tertiary", onClick: () => this.previous() }, index.h("ion-icon", { slot: "icon-only", class: "med-icon", name: "med-esquerda" })), index.h("med-type", { class: "header__type", token: "p16b", ref: (el) => this.monthAndYear = el }), index.h("ion-button", { "ds-name": "tertiary", onClick: () => this.next() }, index.h("ion-icon", { slot: "icon-only", class: "med-icon", name: "med-direita" }))), index.h("div", { class: "header__right" }, index.h("ion-button", { "ds-name": "tertiary" }, index.h("med-type", { class: "choice__type" }, "M\u00EAs"), index.h("ion-icon", { slot: "end", class: "med-icon header__button-icon", name: "med-baixo" })), index.h("ion-icon", { class: "med-icon header__icon", name: "med-grafico" }))), index.h("div", { class: "content" }, index.h("div", { class: "content__header", ref: (el) => this.calendarHead = el }), index.h("div", { class: "content__container", ref: (el) => this.calendarBody = el })), index.h("div", { class: "footer" }, index.h("label", { htmlFor: "month" }, "Jump To: "), index.h("select", { onChange: () => this.jump(), ref: (el) => this.selectMonth = el }, index.h("option", { value: "0" }, "Jan"), index.h("option", { value: "1" }, "Feb"), index.h("option", { value: "2" }, "Mar"), index.h("option", { value: "3" }, "Apr"), index.h("option", { value: "4" }, "May"), index.h("option", { value: "5" }, "Jun"), index.h("option", { value: "6" }, "Jul"), index.h("option", { value: "7" }, "Aug"), index.h("option", { value: "8" }, "Sep"), index.h("option", { value: "9" }, "Oct"), index.h("option", { value: "10" }, "Nov"), index.h("option", { value: "11" }, "Dec")), index.h("select", { onChange: () => this.jump(), ref: (el) => this.selectYear = el }))));
  }
