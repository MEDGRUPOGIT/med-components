...
const MedSearchBar = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: color.generateMedColor(dsColor, {
        'med-search-bar': true,
      }) }, index.h("div", { class: "busca" }, index.h("button", { class: "busca__button", id: "fechar", onClick: (e) => this.toggleClass(e) }, index.h("ion-icon", { class: "med-icon", name: "med-fechar" })), index.h("slot", null)), index.h("div", { class: "title-container" }, index.h("h1", { class: "title-container__title" }, "Conte\u00FAdos"), index.h("button", { class: "title-container__button", id: "busca", onClick: (e) => this.toggleClass(e) }, index.h("ion-icon", { class: "med-icon", name: "med-busca" })))));
  }
  get el() { return index.getElement(this); }
};
MedSearchBar.style = medSearchBarCss;

exports.med_search_bar = MedSearchBar;
