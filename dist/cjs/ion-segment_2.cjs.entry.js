...
const SegmentButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-disabled": disabled ? 'true' : null, class: {
        ...
        'ion-focusable': true,
      } }, index.h("button", { type: type, "aria-pressed": checked ? 'true' : 'false', class: "button-native", part: "native", disabled: disabled }, index.h("span", { class: "button-inner" }, index.h("slot", null))), index.h("div", { part: "indicator", class: {
