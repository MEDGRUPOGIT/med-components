...
const MedTiles = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: medTheme.generateMedColor(dsColor, {
      ...
      }) }, index.h("div", { class: "med-tiles__border" }), index.h("div", { class: "med-tiles__content" }, index.h("h3", { class: "med-tiles__title", innerHTML: titulo }), index.h("h4", { class: "med-tiles__label", innerHTML: label }), index.h("slot", null))));
  }
};
