...
const MedCheckCard = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "from-stencil": true, class: medTheme.generateMedColor(dsColor, {
      ...
      }) }, index.h("med-base", { "spacing-v": "s00", "spacing-h": "s00", class: "med-check-card__base" }, index.h("div", { class: "med-check-card__input-container" }, index.h("slot", { name: "input" })), index.h("div", { class: "med-check-card__container", onClick: () => this.onClick() }, index.h("div", { class: "med-check-card__text-container" }, index.h("med-type", { token: "p16xb" }, titulo), index.h("div", { class: "med-check-card__info-container" }, index.h("div", { class: "med-check-card__container-fix" }, index.h("ion-icon", { class: "med-check-card__icon med-icon med-icon--xs", name: iconName }), index.h("med-type", { class: "med-check-card__subtitulo", token: "p12xb" }, categoria)), !dataInicial && !dataFinal && horaInicial && horaFinal && index.h("med-type", { class: "med-check-card__hora", token: "p12x" }, horaInicial, " \u2013 ", horaFinal)), dataInicial && dataFinal && !horaInicial && !horaFinal && index.h("med-type", { class: "med-check-card__data", token: "p12x" }, dataInicial, " at\u00E9 ", dataFinal), dataInicial && dataFinal && horaInicial && horaFinal && index.h("med-type", { class: "med-check-card__data", token: "p12x" }, dataInicial, " - ", horaInicial, " at\u00E9 ", dataFinal, " - ", horaFinal))), index.h("div", { class: alert ? 'med-check-card__tooltip-container' : '' }, index.h("slot", { name: "tooltip" })))));
  }
};
