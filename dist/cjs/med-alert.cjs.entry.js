...
const MedAlert = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("ion-header", { class: "tp-dialog-header" }, index.h("ion-button", { "ds-name": "tertiary", "ds-size": "xxs", onClick: () => this.dismiss('cancel') }, index.h("ion-icon", { slot: "icon-only", class: "med-icon", name: "med-fechar" }))), index.h("div", { class: "tp-dialog-container" }, index.h("med-type", { class: "tp-dialog-heading", token: "h20x", innerHTML: index$1.sanitizeDOMString(heading) }), index.h("med-type", { "ds-color": "neutral-8", token: "h14x", innerHTML: index$1.sanitizeDOMString(message) }), index.h("div", { class: "tp-dialog-footer" }, cancelText && index.h("ion-button", { "ds-name": "secondary", onClick: () => this.dismiss('cancel') }, cancelText), confirmText && index.h("ion-button", { onClick: () => this.dismiss('confirm') }, confirmText)))));
  }
};
