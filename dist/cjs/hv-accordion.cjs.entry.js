...
const Accordion = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("slot", null), index.h("div", { class: "blocker" })));
  }
  get hostElement() { return index.getElement(this); }
};
Accordion.style = accordionCss;

exports.hv_accordion = Accordion;
