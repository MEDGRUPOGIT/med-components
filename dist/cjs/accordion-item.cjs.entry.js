...
const AccordionItem = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { id: itemId, "from-stencil": true, class: {
        'accordion-item': true,
        'accordion-item--background': background,
        'accordion-item--open': isOpen,
      } }, index.h("div", { class: "accordion-item__header", onClick: () => this.onClick() }, index.h("slot", { name: "header" })), index.h("div", { class: "accordion-item__content", ref: (el) => this.contentElement = el }, index.h("slot", { name: "content" }))));
  }
