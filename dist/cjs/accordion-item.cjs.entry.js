...
const AccordionItem = class {
  ...
  render() {
    const { itemId } = this;
    return (index.h(index.Host, { id: itemId }, index.h("div", { class: "header", onClick: () => this.onClick() }, index.h("slot", { name: "header" })), index.h("div", { class: "content", ref: (el) => this.contentElement = el }, index.h("slot", { name: "content" }))));
  }
...
exports.accordion_item = AccordionItem;
