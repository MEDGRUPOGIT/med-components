...
const FabButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-disabled": disabled ? 'true' : null, class: medTheme.generateMedColor(dsColor, {
      ...
      }) }, index.h(TagType, Object.assign({}, attrs, { class: "button-native", part: "native", disabled: disabled, onFocus: this.onFocus, onBlur: this.onBlur, onClick: (ev) => theme.openURL(href, ev, this.routerDirection, this.routerAnimation) }), index.h("ion-icon", { icon: this.closeIcon, part: "close-icon", class: "med-icon close-icon", lazy: false }), index.h("span", { class: "button-inner" }, index.h("slot", null), index.h("slot", { name: "label" })), mode === 'md' && index.h("ion-ripple-effect", null))));
  }
  get el() { return index.getElement(this); }
};
FabButton.style = {
