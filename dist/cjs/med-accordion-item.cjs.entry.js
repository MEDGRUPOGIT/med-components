...
const MedAccordionItem = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "from-stencil": true, class: medTheme.generateMedColor(dsColor, {
      ...
      }) }, index.h("div", { class: "med-accordion-item__header", ref: (el) => this.header = el }, index.h("div", { class: "med-accordion-item__header-container" }, icon === 'left' && index.h("div", { class: "med-accordion-item__icon-container med-accordion-item__icon-container--left", onClick: () => this.onClick() }, index.h("ion-icon", { class: "med-icon med-accordion-item__icon", name: "med-baixo" })), index.h("div", { class: "med-accordion-item__heading", onClick: () => this.onClick() }, index.h("slot", { name: "header" }), index.h("slot", { name: "auxiliar" })), index.h("slot", { name: "button" }), (!icon || icon === 'right') && index.h("div", { class: "med-accordion-item__icon-container med-accordion-item__icon-container--right", onClick: () => this.onClick() }, index.h("ion-icon", { class: "med-icon med-accordion-item__icon", name: "med-baixo" }))), index.h("div", { class: "med-accordion-item__bar" }, index.h("slot", { name: "progress" }))), index.h("div", { class: "med-accordion-item__content", ref: (el) => this.content = el }, index.h("slot", { name: "content" }))));
  }
