...
const MedAlternativasA = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "from-stencil": true, class: medTheme.generateMedColor(dsColor, {
      ...
      index.h("div", { class: `image-container ${alternativa[this.keyEnunciado] ? 'image-container--margin' : ''}`, onClick: (event) => this.baseClass.imageRequest(event, alternativa) }, index.h("div", { class: 'image-container__wrapper' }, index.h("img", { class: 'image-container__image', src: alternativa[this.keyImagem] }))), index.h("ion-progress-bar", { percentage: true, class: `
                      med-alternativas__progress-bar
                      ${mostraResposta && alternativaSelecionada ? 'med-alternativas__progress-bar--toggle' : ''}
                    `, value: alternativa[this.keyPorcentagem] })), index.h("div", { class: `med-alternativas__riscar ${indice === this.riscarAtivoIndice && permiteRiscar ? 'med-alternativas__riscar--show' : ''}`, onClick: (event) => { this.baseClass.riscar(event, alternativa); } }, index.h("ion-icon", { class: "med-alternativas__riscar-icon med-icon", name: "med-riscar" }), index.h("div", { class: "med-alternativas__riscar-span" }, (alternativa[this.keyRiscada] ? 'Restaurar ' : 'Riscar '), index.h("span", { class: "med-alternativas__riscar-desktop" }, " alternativa")))))))))));
  }
