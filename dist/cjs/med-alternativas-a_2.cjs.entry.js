  ...
  render() {
    ...
    return (index.h(index.Host, { "from-stencil": true, class: medTheme.generateMedColor(dsColor, {
        'med-alternativas': true,
           ...
           `, role: "list" }, this.alternativas.map((alternativa, indice) => (index.h("div", { role: "listitem", onTouchStart: (event) => this.onTouchStart(event, indice), onTouchEnd: (event) => this.onTouchEnd(event, alternativa), onMouseDown: (event) => this.onTouchStart(event, indice), onMouseUp: (event) => this.onTouchEnd(event, alternativa), class: `
      ...
      index.h("div", { class: `image-container ${alternativa[this.keyEnunciado] ? 'image-container--margin' : ''}`, onClick: (event) => this.imageRequest(event, alternativa) }, index.h("div", { class: 'image-container__wrapper' }, index.h("img", { class: 'image-container__image', src: alternativa[this.keyImagem] }), index.h("div", { class: 'image-container__button' }, index.h("ion-icon", { name: "med-expand image-container__icon" }))))), index.h("div", { class: `med-alternativas__riscar ${indice === this.riscarAtivoIndice && permiteRiscar ? 'med-alternativas__riscar--show' : ''}`, onClick: (event) => this.riscar(event, alternativa) }, index.h("ion-icon", { class: "med-alternativas__riscar-icon med-icon", name: "med-riscar" }), index.h("div", { class: "med-alternativas__riscar-span" }, (alternativa[this.keyRiscada] ? 'Restaurar ' : 'Riscar '), index.h("span", { class: "med-alternativas__riscar-desktop" }, " alternativa"))))), index.h("ion-progress-bar", { percentage: true, class: `
...
const MedAlternativasB = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "from-stencil": true, class: medTheme.generateMedColor(dsColor, {
      ...
      index.h("div", { class: `image-container ${alternativa[this.keyEnunciado] ? 'image-container--margin' : ''}`, onClick: (event) => this.imageRequest(event, alternativa) }, index.h("div", { class: 'image-container__wrapper' }, index.h("img", { class: 'image-container__image', src: alternativa[this.keyImagem] }), index.h("div", { class: 'image-container__button' }, index.h("ion-icon", { name: "med-expand image-container__icon" }))))), index.h("div", { class: `med-alternativas__riscar ${indice === this.riscarAtivoIndice && permiteRiscar ? 'med-alternativas__riscar--show' : ''}`, onClick: (event) => this.riscar(event, alternativa) }, (alternativa[this.keyRiscada] ? 'Retomar' : 'Riscar') + ' alternativa'))), index.h("ion-progress-bar", { "ds-name": "skin", percentage: true, class: `
                med-alternativas__progress-bar
                ${mostraResposta && alternativaSelecionada ? 'med-alternativas__progress-bar--toggle' : ''}
              `, value: alternativa[this.keyPorcentagem] })))))));
  }
