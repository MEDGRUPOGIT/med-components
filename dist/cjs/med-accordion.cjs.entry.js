...
const MedAccordion = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "from-stencil": true, class: theme.createColorClasses(color, {
      ...
      }) }, index.h("div", { class: "med-accordion__header", onClick: this.onClick }, icon === 'left' && index.h("div", { class: "med-accordion__icon-container med-accordion__icon-container--left" }, index.h("ion-icon", { class: "med-accordion__icon", name: "med-arrow-down" })), index.h("slot", { name: "header" }), (!icon || icon === 'right') && index.h("div", { class: "med-accordion__icon-container med-accordion__icon-container--right" }, index.h("ion-icon", { class: "med-accordion__icon", name: "med-arrow-down" }))), index.h("div", { class: "med-accordion__content--fake", ref: (el) => this.contentFakeEl = el }, index.h("slot", { name: "content-fake" })), index.h("div", { class: "med-accordion__content", ref: (el) => this.contentEl = el }, index.h("slot", { name: "content" }))));
  }
