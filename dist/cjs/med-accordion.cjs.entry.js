...
const MedAccordion = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "from-stencil": true, class: theme.createColorClasses(color, {
      ...
      }) }, index.h("div", { class: "med-accordion__header", onClick: (event) => this.onClick(event) }, icon === 'left' && index.h("div", { class: "med-accordion__icon-container med-accordion__icon-container--left" }, index.h("ion-icon", { class: "med-icon med-accordion__icon", name: "med-baixo" })), index.h("slot", { name: "header" }), (!icon || icon === 'right') && index.h("div", { class: "med-accordion__icon-container med-accordion__icon-container--right" }, index.h("ion-icon", { class: "med-icon med-accordion__icon", name: "med-baixo" }))), index.h("div", { class: "med-accordion__content--fake", ref: (el) => this.contentFakeEl = el }, index.h("slot", { name: "content-fake" })), index.h("div", { class: "med-accordion__content", ref: (el) => this.contentEl = el }, index.h("slot", { name: "content" }))));
  }
...
MedAccordion.style = medAccordionCss;

exports.med_accordion = MedAccordion;
