...
const MedDownloadButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onClick: (event) => { this.toggle(event); }, class: medTheme.generateMedColor(dsColor, {
      ...
      }) }, index.h("div", { class: "download-icon" }, index.h("svg", { viewBox: "0 0 36 36", class: "download-icon__svg" }, index.h("circle", { cx: "18", cy: "18", r: "16", class: "download-icon__circle" }), index.h("circle", { cx: "18", cy: "18", r: "16", class: "download-icon__circle download-icon__circle--value", style: { '--value': `${value}` } })))));
  }
...
const MedPiechart = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: medTheme.generateMedColor(dsColor, {
      ...
      }) }, index.h("div", { class: "med-piechart__container" }, index.h("div", { class: "med-piechart__side med-piechart__side--front" }, index.h("med-type", { class: "med-piechart__text", token: "p12b" }, text), index.h("svg", { viewBox: "0 0 36 36", style: { '--porcentagem': `${value}` } }, index.h("circle", { class: "med-piechart__circle", cx: "18", cy: "18", r: "16" }), index.h("circle", { cx: "18", cy: "18", r: "16", class: "med-piechart__circle med-piechart__circle--porcentagem" }))), index.h("div", { class: "med-piechart__side med-piechart__side--back" }, index.h("med-type", { class: "med-piechart__text", token: "p12b" }, text)))));
  }
};
