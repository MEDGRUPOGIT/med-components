...
const Radio = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, "aria-labelledby": label ? labelId : null, role: "radio", tabindex: buttonTabindex, onFocus: this.onFocus, onBlur: this.onBlur, class: medTheme.generateMedColor(dsColor, {
        [mode]: true,
        'med-radio': true,
