...
const MedTooltip = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "from-stencil": true, onMouseenter: (event) => { this.toggleOnHover(event); }, onMouseleave: (event) => { this.toggleOnHover(event); }, class: color.generateMedColor(dsColor, {
      ...
      }) }, index.h("div", { class: "med-tooltip__input-container", onClick: (event) => { this.toggle(event); } }, index.h("slot", { name: "input" })), index.h("div", { class: "med-tooltip__content" }, titulo && index.h("div", { class: "med-tooltip__header" }, index.h("med-type", { class: "med-tooltip__titulo" }, titulo), index.h("ion-button", { mode: "ios", "icon-only": true, class: "med-tooltip__button-fechar", "ds-color": !dsColor ? 'neutral-10' : dsColor, fill: "clear", "ds-size": "xxs", onClick: (event) => { this.toggle(event); } }, index.h("ion-icon", { slot: "icon-only", class: "med-icon", name: "med-fechar" }))), content && index.h("med-type", { class: "med-tooltip__text" }, content), index.h("slot", { name: "content" }), (btnLeft || btnRight) && index.h("div", { class: "med-tooltip__footer" }, btnLeft && index.h("ion-button", { mode: "ios", class: "med-tooltip__button", "ds-color": !dsColor ? 'neutral-10' : dsColor, "ds-size": "xxs", fill: "clear", onClick: this.onBtnLeftClick }, " ", btnLeft, " "), btnRight && index.h("ion-button", { mode: "ios", class: "med-tooltip__button", "ds-color": !dsColor ? 'neutral-10' : dsColor, "ds-size": "xxs", fill: "clear", onClick: this.onBtnRightClick }, " ", btnRight, " ")))));
  }
};
MedTooltip.style = medTooltipCss;

exports.med_tooltip = MedTooltip;
