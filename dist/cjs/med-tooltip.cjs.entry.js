...
const MedTooltip = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "from-stencil": true, class: medTheme.generateMedColor(dsColor, {
      ...
      }) }, index.h("div", { class: "med-tooltip__input-container", onClick: (event) => { this.toggle(event); } }, index.h("slot", { name: "input" })), index.h("div", { class: "med-tooltip__content" }, titulo && index.h("h3", { class: "med-tooltip__titulo" }, titulo), content && index.h("p", { class: "med-tooltip__text" }, content), index.h("slot", { name: "content" }))));
  }
};
