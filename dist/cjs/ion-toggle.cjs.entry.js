...
const Toggle = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onClick: this.onClick, "aria-labelledby": label ? labelId : null, "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "switch", class: color.generateMedColor(dsColor, {
        [mode]: true,
        'med-toggle': true,
