...
const Toggle = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onClick: this.onClick, "aria-labelledby": label ? labelId : null, "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "switch", class: medTheme.generateMedColor(dsColor, {
        [mode]: true,
        'med-toggle': true,
        'in-item': theme.hostContext('ion-item', el) || theme.hostContext('med-item', el),
