...
const BackButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onClick: this.onClick, class: theme.createColorClasses(color, {
      ...
      }) }, index.h("button", { type: type, disabled: disabled, class: "button-native", part: "native", "aria-label": backButtonText || 'back' }, index.h("span", { class: "button-inner" }, backButtonText && index.h("span", { part: "text", "aria-hidden": "true", class: "button-text" }, backButtonText)), index.h("slot", null), mode === 'md' && index.h("ion-ripple-effect", { type: this.rippleType }))));
  }
