...
const MedChartBar = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: medTheme.generateMedColor(dsColor, {
        'med-chart-bar': true
      }) }, index.h("div", { class: "med-chart-bar__container", style: { '--value': `${percentage}`, '--height': `${height}px`, '--width': `${width}px` } }, index.h("med-type", { class: "med-chart-bar__label", token: token }, value, "%"), index.h("div", { class: "med-chart-bar__progress" }))));
  }
};
