...
const MedAlternativas = class {
  ...
  render() {
    ...
    index.h("div", { id: 'div' + alternativa.Alternativa }, index.h("li", { class: this.cssClassAlternativa(alternativa[this.keyAlternativa]) + (alternativa.Pressionada ? ' alternativa--pode-riscar-mobile' : '') }, index.h("med-option", { class: this.cssClassOption(alternativa) }, index.h("ion-radio", { value: alternativa[this.keyAlternativa] }), index.h("label", { slot: "label" }, alternativa[this.keyAlternativa])), index.h("div", { class: 'alternativa__right' }, alternativa[this.keyEnunciado] && index.h("div", { class: 'alternativa__text', innerHTML: alternativa[this.keyEnunciado] }), index.h("div", { class: 'image-container', onClick: () => this.imageRequest(alternativa) }, alternativa[this.keyImagem] && index.h("img", { class: 'alternativa__image', src: alternativa[this.keyImagem] }), index.h("div", { class: 'overlay' }, index.h("div", { class: "overlay__content" }, index.h("p", { class: "overlay__label" }, "clique para ampliar"), index.h("ion-icon", { name: "med-expand" })))), !alternativa.Riscada &&
