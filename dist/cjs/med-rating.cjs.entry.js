...
const MedRating = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "from-stencil": true, class: medTheme.generateMedColor(dsColor, {
      ...
      }) }, index.h("div", { class: "med-rating__left" }, index.h("ion-icon", { name: cabe ? "med-positivo" : "med-negativo", class: "med-icon med-rating__icon" })), index.h("div", { class: "med-rating__right" }, index.h("span", { class: "med-rating__name" }, nome), " ", index.h("span", { class: "med-rating__date" }, data), index.h("p", { class: "med-rating__concurso" }, concurso), index.h("span", { class: "med-rating__text" }, texto), (dsName === 'medgrupo') && index.h("ion-icon", { name: "med-logo", class: "med-icon med-rating__icon-medgrupo" }))));
  }
};
