...
export class MedDownloadButton {
  ...
  render() {
    ...
    return (h(Host, { onClick: (event) => { this.toggle(event); }, class: generateMedColor(dsColor, {
      ...
      h("div", { class: "download-icon" },
        h("svg", { viewBox: "0 0 36 36", class: "download-icon__svg" },
          h("circle", { cx: "18", cy: "18", r: "16", class: "download-icon__circle" }),
          h("circle", { cx: "18", cy: "18", r: "16", class: "download-icon__circle download-icon__circle--value", style: { '--value': `${value}` } })))));
  }
