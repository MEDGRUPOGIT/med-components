...
export class MedSearchBar {
  ...
  render() {
    ...
    return (h(Host, { class: generateMedColor(dsColor, {
      ...
      h("div", { class: "busca" },
        h("button", { class: "busca__button", id: "fechar", onClick: (e) => this.toggleClass(e) },
          h("ion-icon", { class: "med-icon", name: "med-fechar" })),
        h("slot", null)),
      h("div", { class: "title-container" },
        h("h1", { class: "title-container__title" }, "Conte\u00FAdos"),
        h("button", { class: "title-container__button", id: "busca", onClick: (e) => this.toggleClass(e) },
