  ...
  render() {
    return (h(Host, null,
      ...
      h("ion-content", { class: "modal-content" },
        h("div", { class: "modal-local" },
          h("ion-label", { class: "modal-local__title" }, "Selecione os estados"),
          h("ion-item", { class: "modal-local__opcoes", mode: "ios", lines: "none", "ds-color": "neutral-15" },
            h("ion-label", null, "AL")),
          h("ion-item", { class: "modal-local__opcoes", mode: "ios", lines: "none", "ds-color": "neutral-15" },
            h("ion-label", null, "AL")),
          h("ion-item", { class: "modal-local__opcoes", mode: "ios", lines: "none", "ds-color": "neutral-15" },
