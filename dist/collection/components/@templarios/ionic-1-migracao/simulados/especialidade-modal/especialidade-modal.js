  ...
  render() {
    return (h(Host, null,
      ...
      h("ion-content", { class: "modal-content" },
        h("div", { class: "modal-especialidade" },
          h("ion-label", { class: "modal-especialidade__title" }, "Especialidade"),
          h("ion-item", { class: "modal-especialidade__opcoes", mode: "ios", lines: "none", "ds-color": "neutral-15" },
