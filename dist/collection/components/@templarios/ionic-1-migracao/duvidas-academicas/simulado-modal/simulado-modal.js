  ...
  render() {
    return (h(Host, null,
      ...
      h("ion-content", { class: "modal-content" },
        h("div", { class: "modal-simulados" },
          h("ion-label", { class: "modal-simulados__title" }, "Simulados"),
          h("ion-item", { class: "modal-simulados__opcoes", mode: "ios", lines: "none", "ds-color": "neutral-15" },
