  ...
  render() {
    return (h(Host, null,
      ...
      h("ion-content", { class: "modal-content" },
        h("div", { class: "modal-concursos" },
          h("ion-label", { class: "modal-concursos__title" }, "Concursos"),
          h("div", { class: "modal-concursos__input" },
          ...
          h("ion-item", { class: "modal-concursos__opcoes", mode: "ios", lines: "none", "ds-color": "neutral-15" },
