  ...
  render() {
    return (h(Host, null,
      ...
      h("ion-content", { class: "modal-content" },
        h("div", { class: "modal-apostilas" },
          h("ion-label", { class: "modal-apostilas__title" }, "Apostilas"),
          h("div", { class: "modal-apostilas__input" },
          ...
          h("ion-item", { class: "modal-apostilas__opcoes", mode: "ios", lines: "none", "ds-color": "neutral-15" },
