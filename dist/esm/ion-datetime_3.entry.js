...
import { h as hostContext, g as getClassMap } from './theme-3b0eafd2.js';
...
const Datetime = class {
  ...
  render() {
    ...
    return (h(Host, { onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, "aria-expanded": `${isExpanded}`, "aria-haspopup": "true", "aria-labelledby": labelId, class: {
      ...
      } }, h("div", { class: "datetime-text", part: datetimeTextPart }, datetimeText), h("ion-icon", { class: "datetime-icon med-icon", slot: "icon-only", name: iconName }), h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: btnEl => this.buttonEl = btnEl })));
  }
