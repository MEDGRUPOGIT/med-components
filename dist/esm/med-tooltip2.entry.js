...
const MedTooltip2 = class {
  ...
  render() {
    ...
    if (buttonLeft || buttonRight) {
      buttonContainer = (h("div", { class: "button-container" }, buttonLeftEl, buttonRightEl));
    }
    return (h(Host, { "from-stencil": true, class: { 'simple': simple } }, header && h("h4", { class: "header" }, header), content && h("p", { class: "content" }, content), buttonContainer));
  }
};
MedTooltip2.style = medTooltip2Css;

export { MedTooltip2 as med_tooltip2 };
