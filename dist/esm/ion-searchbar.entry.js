...
const Searchbar = class {
  ...
  render() {
    ...
    return (h(Host, { role: "search", "aria-disabled": this.disabled ? 'true' : null, class: createColorClasses(this.color, {
      ...
      }) }, h("div", { class: "searchbar-input-container" }, h("ion-icon", { "aria-hidden": "true", class: "med-icon med-icon-search", mode: mode, icon: searchIcon, lazy: false }), h("input", { "aria-label": "search text", disabled: this.disabled, ref: el => this.nativeInput = el, class: "searchbar-input", inputMode: this.inputmode, enterKeyHint: this.enterkeyhint, onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, placeholder: this.placeholder, type: this.type, value: this.getValue(), autoComplete: this.autocomplete, autoCorrect: this.autocorrect, spellcheck: this.spellcheck }), mode === 'md' && cancelButton, h("button", { "aria-label": "reset", type: "button", "no-blur": true, class: "searchbar-clear-button", onMouseDown: ev => this.onClearInput(ev, true), onTouchStart: ev => this.onClearInput(ev, true) }, h("ion-icon", { "aria-hidden": "true", class: "med-icon searchbar-clear-icon", mode: mode, icon: clearIcon, lazy: false }))), mode === 'ios' && cancelButton));
  }
