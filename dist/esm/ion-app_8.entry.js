import { r as registerInstance, h, H as Host, i as getElement, e as createEvent, f as readTask, j as forceUpdate, c as writeTask } from './index-ec43b846.js';
import { b as getIonMode, c as config, a as isPlatform } from './ionic-global-d64985b2.js';
...
import { t as transition } from './index-5faf8f21.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-0690f8b9.js').then(module => module.startStatusTap());
        }
