...
const MedCheckCard = class {
  ...
  render() {
    ...
    return (h(Host, { "from-stencil": true, class: generateMedColor(dsColor, {
      ...
      }) }, h("med-base", { class: "med-check-card__base" }, h("div", { class: "med-check-card__input-container" }, h("slot", { name: "input" })), h("div", { class: "med-check-card__container", onClick: () => this.onClick() }, h("div", { class: "med-check-card__text-container" }, h("med-type", { token: "p16xb" }, titulo), h("div", { class: "med-check-card__info-container" }, h("ion-icon", { class: "med-check-card__icon med-icon med-icon--xs", name: iconName }), h("med-type", { class: "med-check-card__subtitulo", token: "p12xb" }, categoria), !dataInicial && !dataFinal && h("med-type", { class: "med-check-card__hora", token: "p12x" }, horaInicial, " \u2013 ", horaFinal)), dataInicial && dataFinal && h("med-type", { class: "med-check-card__data", token: "p12x" }, dataInicial, " - ", horaInicial, " at\u00E9 ", dataFinal, " - ", horaFinal))), h("div", { class: alert ? 'med-check-card__tooltip-container' : '' }, h("slot", { name: "tooltip" })))));
  }
};
