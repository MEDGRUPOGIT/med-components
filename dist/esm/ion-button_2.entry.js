...
const Button = class {
  ...
  render() {
    ...
    return (h(Host, { ragatanga: true, onClick: this.handleClick, "aria-disabled": disabled ? 'true' : null, class: createColorClasses$1(color, {
        [mode]: true,
        [buttonType]: true,
