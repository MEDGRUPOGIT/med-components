...
const AccordionItem = class {
  ...
  render() {
    const { itemId } = this;
    return (h(Host, { id: itemId }, h("div", { class: "header", onClick: () => this.onClick() }, h("slot", { name: "header" })), h("div", { class: "content", ref: (el) => this.contentElement = el }, h("slot", { name: "content" }))));
  }
