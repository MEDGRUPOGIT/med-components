...
const MedNavbar = class {
  ...
  render() {
    return (h(Host, { "from-stencil": true }, h("header", { class: "header" }, h("slot", { name: "top" }), h("div", { class: "header__container" }, h("div", { id: "left", class: "left", ref: (el) => this.leftEl = el }, h("slot", { name: "left" })), h("div", { class: "center", ref: (el) => this.centerEl = el }, h("slot", { name: "center" }), h("slot", { name: "title" }), h("slot", { name: "subtitle" })), h("div", { id: "right", class: "right", ref: (el) => this.rightEl = el }, h("slot", { name: "right" }))))));
  }
