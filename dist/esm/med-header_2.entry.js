...
const MedNavbar = class {
  ...
  render() {
    return (h(Host, { class: "med-navbar", "from-stencil": true }, h("header", { class: "header" }, h("slot", { name: "top" }), h("div", { class: "header__container" }, h("div", { id: "left", class: "left", ref: (el) => this.leftEl = el }, h("slot", { name: "left" })), h("div", { class: "center", ref: (el) => this.centerEl = el }, h("slot", { name: "title" }), h("slot", { name: "subtitle" })), h("div", { id: "right", class: "right", ref: (el) => this.rightEl = el }, h("slot", { name: "right" }))))));
  }
  get el() { return getElement(this); }
};
