...
const MedChartBar = class {
  ...
  render() {
    ...
    return (h(Host, { class: generateMedColor(dsColor, {
        'med-chart-bar': true
      }) }, h("div", { class: "med-chart-bar__container", style: { '--value': `${percentage}`, '--height': `${height}px`, '--width': `${width}px` } }, h("med-type", { class: "med-chart-bar__label", token: token }, value, "%"), h("div", { class: "med-chart-bar__progress" }))));
  }
};
