...
const MedAlternativasA = class {
  ...
  render() {
    ...
    return (h(Host, { "from-stencil": true, class: generateMedColor(dsColor, {
      ...
      h("div", { class: `image-container ${alternativa[this.keyEnunciado] ? 'image-container--margin' : ''}`, onClick: (event) => this.imageRequest(event, alternativa) }, h("div", { class: 'image-container__wrapper' }, h("img", { class: 'image-container__image', src: alternativa[this.keyImagem] }), h("div", { class: 'image-container__button' }, h("ion-icon", { name: "med-expand image-container__icon" }))))), h("div", { class: `med-alternativas__riscar ${indice === this.riscarAtivoIndice && permiteRiscar ? 'med-alternativas__riscar--show' : ''}`, onClick: (event) => this.riscar(event, alternativa) }, h("ion-icon", { class: "med-alternativas__riscar-icon med-icon", name: "med-riscar" }), h("div", { class: "med-alternativas__riscar-span" }, (alternativa[this.keyRiscada] ? 'Restaurar ' : 'Riscar '), h("span", { class: "med-alternativas__riscar-desktop" }, " alternativa"))))), h("ion-progress-bar", { percentage: true, class: `
...
const MedAlternativasB = class {
  ...
  render() {
    ...
    return (h(Host, { "from-stencil": true, class: generateMedColor(dsColor, {
      ...
      h("div", { class: `image-container ${alternativa[this.keyEnunciado] ? 'image-container--margin' : ''}`, onClick: (event) => this.imageRequest(event, alternativa) }, h("div", { class: 'image-container__wrapper' }, h("img", { class: 'image-container__image', src: alternativa[this.keyImagem] }), h("div", { class: 'image-container__button' }, h("ion-icon", { name: "med-expand image-container__icon" }))))), h("div", { class: `med-alternativas__riscar ${indice === this.riscarAtivoIndice && permiteRiscar ? 'med-alternativas__riscar--show' : ''}`, onClick: (event) => this.riscar(event, alternativa) }, (alternativa[this.keyRiscada] ? 'Retomar' : 'Riscar') + ' alternativa'))), h("ion-progress-bar", { "ds-name": "skin", percentage: true, class: `
                med-alternativas__progress-bar
                ${mostraResposta && alternativaSelecionada ? 'med-alternativas__progress-bar--toggle' : ''}
              `, value: alternativa[this.keyPorcentagem] })))))));
  }
